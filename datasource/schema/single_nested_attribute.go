...
var _ NestedAttribute = SingleNestedAttribute{}
...
// accept an of object or an attribute name directly via period syntax:
//
...
// func (a SingleNestedAttribute) GetValidators() []tfsdk.AttributeValidator {
// 	return a.Validators
// }
