...
var _ NestedAttribute = ListNestedAttribute{}
...
// GetAttributes returns the NestedObject Attributes field value.
func (a ListNestedAttribute) GetAttributes() fwschema.UnderlyingAttributes {
	return schemaAttributes(a.NestedObject.Attributes)
}
...
// func (a ListNestedAttribute) GetValidators() []tfsdk.AttributeValidator {
// 	return a.Validators
// }
